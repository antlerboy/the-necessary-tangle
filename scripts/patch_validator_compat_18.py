#!/usr/bin/env python3
"""Extend retained historical validation release sets to recognise 0.18."""
...
if not changed and not already:
    raise SystemExit("No historical validator release set recognised for 0.18 compatibility")
