...
ALLOWED_RELEASES = {EXPECTED_RELEASE, "0.14-snowden-cynefin-alpha", "0.15-ing-reading-practice-alpha", "0.16-grammar-connections-presentation-alpha", "0.17-public-intake-lineage-alpha", "0.18-navigable-tangle-alpha"}
...
def main() -> int:
    ...
    if meta.get("release") not in {"0.17-public-intake-lineage-alpha", "0.18-navigable-tangle-alpha"} and (ROOT / "documentation" / "feedback-ledger.md").exists():
