...
meta=D['meta']; assert meta['release'] in {'0.15-ing-reading-practice-alpha','0.16-grammar-connections-presentation-alpha', '0.17-public-intake-lineage-alpha', '0.18-navigable-tangle-alpha', '0.19-living-marks-alpha', '0.20-prior-maps-alpha', '0.21'}; assert meta['generated']==('2026-08-31' if meta['release']=='0.21' else ('2026-08-25' if meta['release'] in {'0.19-living-marks-alpha','0.20-prior-maps-alpha'} else ('2026-08-23' if meta['release']=='0.18-navigable-tangle-alpha' else ('2026-08-19' if meta['release']=='0.17-public-intake-lineage-alpha' else '2026-08-14'))))
