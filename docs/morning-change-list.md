...
- Added a machine-readable relationship-quality baseline and review queues.
- Added a sequential overnight log with explicit regression and uncertainty reporting.
- Captured desktop and 375px mobile home/map baselines.
