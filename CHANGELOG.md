...
- separated the public GitHub Pages build from private editorial material;
- removed noisy automatically generated aliases;
- added substantive public descriptions for all 33 Grammar of Systems laws and principles;
- fixed the unresolved Kurt Gödel public entry;
- made map labels and lines selectable and improved fit, zoom and path views;
- improved question parsing so ordinary questions can match several concepts;
