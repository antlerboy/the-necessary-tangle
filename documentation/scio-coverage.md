...
SCiO is represented as a professional body, source corpus, practitioner network and training provider. Appearance in its competency framework, SysBoK, resource library or course catalogue establishes that SCiO recognises, teaches, hosts or discusses an approach; it does not prove that approach or make SCiO the sole authority on it.
...
|---|---:|---:|
| Confrontation Analysis (CONAN) | described | 0 |
| Critical Systems Heuristics (CSH) | profile | 2 |
| INFORMED Group Dynamics | described | 0 |
| Interactive Management | described | 0 |
| Interactive Planning | described | 0 |
| Mosaic Transformation | described | 1 |
