...
| Archive and comparator ingestion | Registers and issues exist for several named corpora | Programme defined, much not mined | Complete item-level passes for Foundational Papers, relevant Monoskop material, SysCoI/model.report and prior maps/BoKs |
