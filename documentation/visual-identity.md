...
The Necessary Tangle keeps a stable name, wordmark, navigation, cream/red reading environment, favicon and bottom-right magic dot. The adjacent visual mark varies on each fresh load.

The source studies came from Benjamin P Taylor's `Systems Thinking/SysCoCyBok/logoso` folder. The working prompts and notes point towards four motifs:

- cats are scientists;
- structural coupling;
- impossible stuff;
- the Wittgenstein duck/rabbit: identity changes with the distinction through which it is seen.

A single polished badge would misdescribe the project. The atlas is held together by maintained distinctions, evidence and recognisable practice, not by freezing one picture forever.
...
Variation does not mean identity soup. The project still relies on stable public commitments:

- every connection says what it means;
- provenance and claim status remain inspectable;
- the name and navigation stay familiar;
- the cream, red, black and magic-dot identity remains;
- failure falls back to a legible, static mark rather than a blank space.
