...
The Necessary Tangle is a public atlas backed by a structured evidence graph. It is not a crowd-edited page system in which any visitor can overwrite the current account.
...
- a source record;
- an evidence locator;
- a challenge or competing account.
...
GitHub supplies useful wiki-like functions: identity, discussion, revision history, issues and pull requests. The public product remains purpose-built because it needs typed graph relationships, paths, lineage layers, source-aware maps and guided conceptual journeys.
